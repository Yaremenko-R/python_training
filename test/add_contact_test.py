...
def test_add_contact(app):
    ...
    contact = Contact(firstname="fnn", middlename="mn", lastname="ln", nickname="nn", title="title", company="company", address="address", homephone="12345", mobilephone="54321", workphone="09876", fax="fax",
